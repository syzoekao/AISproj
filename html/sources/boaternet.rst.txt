...
* Using M1, we predicted the probability of edge formation between any pair of lakes. 
	...
	* If the predicted probability was ≥ 0.36, we assumed the link existed; if the predicted probability was < 0.36, we randomly sample whether the link existed using binomial distribution with the predicted probability. 
