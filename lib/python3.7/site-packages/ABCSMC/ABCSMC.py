...
def tolerance(method, epsMax = 125, epsMin = 40, generation = 10): 
	if method == 'constant': 
...
def init_particle(run, env):
	...
	weight = 1
	return {"par": k_X, "distance": distance, "llk": llk, "weight": weight, 'sim_target': sim_target}
