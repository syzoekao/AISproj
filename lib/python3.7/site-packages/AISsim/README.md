...
* `infest_outcome_func()` is built for Bayesian calibration process to obtain the posterior parameter sets. <font color='red'>This function is not used for risk simulation for each lake.</font>
