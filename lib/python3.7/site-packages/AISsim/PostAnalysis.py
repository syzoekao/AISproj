...
pre_risk_zm = pd.merge(att[['id','dow','lake_name', 'county_name', 'utm_x', 'utm_y', 'acre', 'infest_zm', 'zm_infest2018']], output, how = 'left', 
...
pre_risk_ss = pd.merge(att[['id','dow','lake_name', 'county_name', 'utm_x', 'utm_y', 'acre', 'infest_ss', 'ss_infest2018']], output, how = 'left', 
	left_on = 'id', right_on = 'id')
